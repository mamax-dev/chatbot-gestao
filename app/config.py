...
API_BUSY_MESSAGE = "O serviço de IA está temporariamente ocupado. Aguarde alguns instantes e tente novamente."
...
CACHE_VERSION = os.getenv("CACHE_VERSION", "stable-v3")
AI_RETRY_ATTEMPTS = int(os.getenv("AI_RETRY_ATTEMPTS", "2"))
AI_RETRY_BASE_SECONDS = float(os.getenv("AI_RETRY_BASE_SECONDS", "2.0"))

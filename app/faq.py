...
def lookup(question):
    ...
    institutional_value_markers = (
        ...
        'principios institucionais', 'valor a empresa defende', 'valor que a empresa defende', 'valores institucionais da empresa',
    )
    ...
    price_list_markers = (
        ...
        'valor dos servicos', 'tabela de valores', 'preco de um servico',
        'preco de servico', 'precos dos servicos', 'valor de um servico',
    )
    general_price_query = (

...
def classify_before_model(question: str) -> dict | None:
    ...
    generic_question = normalized in GENERIC_AMBIGUOUS_PHRASES

    if generic_question and not has_specific_service:
        return {
            "answer": AMBIGUOUS,
            "evidence": "",
            "status": "ambiguous",

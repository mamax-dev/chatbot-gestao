...
def answer_from_text(question: str, document_text: str) -> dict | None:
    ...
    # What the company does is answered by all service blocks.
    if has(q,"o que a empresa faz","o que voces fazem","quais servicos a empresa oferece","servicos oferecidos","resumo dos servicos"):
        blocks=[]
